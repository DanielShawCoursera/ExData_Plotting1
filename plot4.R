...
plot(time,powerData$Global_active_power,type="l",ylab = "Global Active Power")

plot(time,powerData$Voltage,type="l",ylab = "Voltage")
...
plot(time,powerData$Global_reactive_power,type="l",ylab = "Global reactive power")
